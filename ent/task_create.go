...
func (tc *TaskCreate) SetDetail(s string) *TaskCreate {
...
func (tc *TaskCreate) check() error {
	...
	if _, ok := tc.mutation.Detail(); !ok {
		return &ValidationError{Name: "detail", err: errors.New(`ent: missing required field "Task.detail"`)}
	}
	return nil
}
...
func (tc *TaskCreate) createSpec() (*Task, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.Detail(); ok {
		_spec.SetField(task.FieldDetail, field.TypeString, value)
		_node.Detail = value
	}
	return _node, _spec
}
